...
function searchCity(lat,lon) {
  fetch(`https://api.openweathermap.org/data/2.5/onecall?lat=${lat}&lon=${lon}&exclude=hourly,minutely&units=imperial&appid=48da628734e9fec404e0b749f53c4fc7`)
    ...
    .then(function (data) {
      ...
      var temp = "temperature:"+data.current.temp
      var humidity = "humidity:"+data.current.humidity
      var uvi = "uvi:"+data.current.uvi
      var windSpeed = "windSpeed:"+data.current.wind_speed
      current.append(temp,humidity,uvi,windSpeed)
      var fiveDay = document.querySelector(".five-day")
      var tempday1 = "temperature:"+data.daily[0].temp.day
      var windday1 ="windSpeed:"+data.daily[0].wind_speed
      var humidity1 ="humidity:"+data.daily[0].humidity
      ...
      fiveDay.append(tempday1,windday1,humidity1,tempday2,windday2,humidtiy2,tempday3,windday3,humidity3,tempday4,windday4,humidtiy4,tempday5,windday5,humidtiy5)
    });
}
